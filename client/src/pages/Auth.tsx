...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col p-4">
                ...
                <CardFooter className="flex-col gap-2">
                  ...
                  <div className="grid grid-cols-2 gap-3 w-full">
                    <Button
                      type="button"
                      variant="outline"
                      className="bg-white/[0.05] border-white/[0.1] hover:bg-white/[0.1] text-white"
      ...
      <Button
        variant="ghost"
        className="mt-4 text-white/50 hover:text-white hover:bg-white/[0.05]"
        onClick={() => {
          localStorage.setItem('orphanbars_guest_mode', 'true');
          setLocation("/");
        }}
