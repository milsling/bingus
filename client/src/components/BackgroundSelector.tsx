...
export const IMAGE_BACKGROUNDS: Background[] = [
  ...
  { id: 'neon-leaves', name: 'Neon Leaves', image: neonLeaves, unlockLevel: 0 },
  { id: 'city-night', name: 'City Night', image: cityNight, unlockLevel: 0 },
  { id: 'holographic-money', name: 'Holographic', image: holographicMoney, unlockLevel: 0 },
  { id: 'rain-alley', name: 'Rain Alley', image: rainAlley, unlockLevel: 0 },
  { id: 'nowhere-station', name: 'Nowhere', image: nowhereStation, unlockLevel: 0 },
  { id: 'neon-sign', name: 'Neon Sign', image: neonSign, unlockLevel: 0 },
  { id: 'neon-face', name: 'Neon Face', image: neonFace, unlockLevel: 0 },
  { id: 'cyber-skull', name: 'Cyber Skull', image: cyberSkull, unlockLevel: 0 },
  { id: 'vaporwave-statue', name: 'Vaporwave', image: vaporwaveStatue, unlockLevel: 0 },
];
